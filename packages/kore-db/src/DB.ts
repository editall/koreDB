...
abstract class DB{
    ...
    protected constructor(dbName:string, version:number = 1){
        this.#openAwait = new Promise((resolve, reject) => {
            ...
            request.onupgradeneeded = ()=>{
                ...
                this.onCreate(
                    <TABLE extends Table<TABLE>>(tableClass:new () => TABLE):TableWrapper<TABLE>=>{
    ...
    abstract onCreate(f:<TABLE extends Table<TABLE>>(tableClass:new ()=>TABLE)=>TableWrapper<TABLE>):void;
